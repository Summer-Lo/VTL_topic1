...
if("TRUE" STREQUAL "TRUE")
  set(virtualrobotv2_SOURCE_PREFIX /home/topic1/Desktop/VTL_topic1/src)
  set(virtualrobotv2_DEVEL_PREFIX /home/topic1/Desktop/VTL_topic1/devel)
  ...
  set(virtualrobotv2_INSTALL_PREFIX /home/topic1/Desktop/VTL_topic1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'virtualrobotv2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/topic1/Desktop/VTL_topic1/src/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/topic1/Desktop/VTL_topic1/devel/lib;/opt/ros/melodic/lib)
